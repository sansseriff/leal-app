 ...
 */
export function constrain(element: HTMLElement, size: number, min: string, max: string, pos: string, priority: string) {
 ...
 * @param {number} size
 */
function normalize(str: string, element: HTMLElement, size) {
